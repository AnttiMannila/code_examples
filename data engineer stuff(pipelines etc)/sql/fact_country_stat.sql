...
create table "staging".indicators_country (like public.indicators including all);

create table "staging".fact_country_stat (like public.indicators including all);
