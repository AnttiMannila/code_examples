...
*/	
	...
	FROM 'C:\Code\imf-dm-export-20240205cleaned.csv'
	DELIMITER ';'
	CSV HEADER;
...
INSERT "staging".fact_country_stat
...
-- Dropping column region_name and indicator_code
ALTER TABLE "staging".fact_country_stat
DROP COLUMN country_name, indicator_code;
...
-- Dropping column region_name and indicator_code
ALTER TABLE "staging".fact_region_stat
DROP COLUMN region_name, indicator_code;
